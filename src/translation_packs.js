var pack1 = {
    ...
    6: [
        "password or username can not be empty",
        "رمز عبور یا نام کاربری نمیتواند خالی باشد",
    ],
    ...
    10: ["enter a username:", "یک نام کاربری انتخاب کنید :"],
    11: ["username is taken", "این نام کاربری گرفته شده است"],
    12: ["enter a password:", "رمز عبوری وارد کنید:"],
    13: ["validations", "اعتبار سنجی ها"],
    14: ["rules", "شروط"],
    15: ["username rules : ", "شروط نام کاربری"],
    ...
    27: ["username availability", "در دسترس بودن رمز عبور"],
    ...
    37: ["mobile phone", "یک شماره موبایل"],
    38: ["user_id", "یک شناسه کاربری"],
    39: ["username", "یک نام کاربری"],
    ...
    186: ["mobile", "شماره موبایل"],
    187: ["username", "نام کاربری"],
