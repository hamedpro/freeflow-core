...
var dev_script_parallel_parts = [`npx tailwindcss -c ./tailwind.config.cjs -i ./src/input.css -o ./src/output.css --watch`,`vite --host --strictPort --port ${frontend_port}`,`nodemon ./api/server.cjs`]
if(mode == "dev"){
